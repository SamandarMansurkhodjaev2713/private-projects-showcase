...
| Проект | Что можно открыть | Сигнал |
|---|---|---|
| [Klawis](https://klawis.uz) | Live product | AI product, legal-tech UX, RAG direction, roadmap |
| [CoupleOS / Softly](https://softlylove.uz) | Live product | Founder-led consumer product, emotional UX, mobile-first |
| [3d-landing](https://samandarmansurkhodjaev2713.github.io/3d-landing/) | Live demo + public repo | Three.js/WebGL, visual frontend, motion |
| [Sentinel Edge](https://samandarmansurkhodjaev2713.github.io/sentinel-edge-smart-system/) | Dashboard demo + public repo | Embedded/full-stack, realtime dashboard |
| [CV-Samandar](https://samandarmansurkhodjaev2713.github.io/CV-Samandar/) | Live portfolio/CV | Personal brand, frontend polish, presentation |
| [Task-manager](https://github.com/SamandarMansurkhodjaev2713/Task-manager) | Public repo + CI | Rust Telegram bot, clean architecture, GitHub Actions |

## Что подготовить визуально дальше
...
## Live And Verifiable Proof

| Project | What can be opened | Signal |
|---|---|---|
| [Klawis](https://klawis.uz) | Live product | AI product, legal-tech UX, RAG direction and roadmap |
| [CoupleOS / Softly](https://softlylove.uz) | Live product | Founder-led consumer product, emotional UX and mobile-first thinking |
| [3d-landing](https://samandarmansurkhodjaev2713.github.io/3d-landing/) | Live demo + public repo | Three.js/WebGL, visual frontend and motion |
| [Sentinel Edge](https://samandarmansurkhodjaev2713.github.io/sentinel-edge-smart-system/) | Dashboard demo + public repo | Embedded/full-stack and realtime dashboard |
| [CV-Samandar](https://samandarmansurkhodjaev2713.github.io/CV-Samandar/) | Live portfolio/CV | Personal brand, frontend polish and presentation |
| [Task-manager](https://github.com/SamandarMansurkhodjaev2713/Task-manager) | Public repo + CI | Rust Telegram bot, clean architecture and GitHub Actions |

## What To Prepare Visually Next
